...
function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      title: "Luma Store & Developer Portal",
      description: "Discover premium apps in the Luma Store or publish your own through our new developer portal with 0% revenue share.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
